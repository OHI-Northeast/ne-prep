...
So Connecticut is missing one year for Hard Clam, Massachusetts is missing 2012 and 2013 for Quahog and Oysters, Rhode Island is missing 2010 for Oysters and Hard Clam. 
...
prod_3yr <- production_df %>%
  ...
  mutate(prod_avg_3yr = zoo::rollapply(pounds, 3, FUN = mean, align = "right", na.rm = F, partial = T), #calculate the mean for three years
...
```{r}
write_csv(prod_3yr, "~/github/ne-scores/region/layers/mar_production.csv")
```
