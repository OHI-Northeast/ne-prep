...
This script creates a dataframe that contains all species in the Northeast for which we have maps either from IUCN RedList or the Northeast Ocean Data Portal. It also links each species with the status score based on NatureServe information pulled from `4_get_natureserve_data.Rmd`.
...
#forloop for each species to grab status
