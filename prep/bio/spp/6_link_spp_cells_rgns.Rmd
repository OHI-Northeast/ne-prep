...
write.csv(dp_spp_rgns, file = "data/6_ne_dataportal_spp_by_rgn.csv")
```
...
iucn_spp_rgns_area <- purrr::map_df(iucn_list, get_sp_rgn_iucn)

write.csv(iucn_spp_rgns_area, file = "data/6_ne_iucn_spp_by_rgn.csv")
```
