...
I'll do the same, using the IUCN API, for Northeast dataportal species without a status. This is just 49 species.
...
Looks like these 49 species don't have a status in the IUCN database!
