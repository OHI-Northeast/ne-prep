...
#save
write.csv(eee_score, file = "data/eee_score.csv")
```
...
write.csv(clim_act, file = "data/clim_act.csv")
```
...
#save
write.csv(energy_consump_scores, file = "data/power_gen_scores_nuc.csv")
```
...
emissions_scores <- emissions_target %>% 
  mutate(score = target/emission,
         score = if_else(score >1, 1, score)) 
#save
write.csv(emissions_scores, file = "data/emissions_scores.csv")
```
