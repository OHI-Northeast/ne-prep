...
# Summary
This script calculates the percentage of fish landed that area managed or regulation in some way.

**List of species landed with stock assessments**
**Description** The data was compiled manually by me using NOAA Fisheries landings data and doing research on whether federal or state agencies include those species in either a management plan or some type of fishing regulation
