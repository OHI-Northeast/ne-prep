...
**will need to write this as csv in reorganization**

Visualize
```{r visualize}
percent_assesses_graph <- ggplot(landed_ass)+
...
ggsave("figs/percent_assesses_graph.jpg", width=7, height=5, dpi=300)
```
