---
title: "OHIEC: Resilience - Climate Change Resilience Layer Calculations"
...
write.csv(res_climate_change, file.path(dir_git,"prep/resilience/ecological/water_pollution/data/res_climate_change.csv"))
```
