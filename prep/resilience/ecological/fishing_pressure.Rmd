...
percent_eezwater_protec <- ggplot(marineEEZ_protected_by_rgn, aes(x = year, y = prop_area, color = rgn_name)) +
  geom_line() +
  theme_classic() +
  geom_hline(yintercept=0.3)+
  labs(y = "Percentage", x = "Year") +
  ggtitle("Percentage of EEZ waters protected")

#ggsave("figs/percent_eezwater_protec.jpg", width=7, height=5, dpi=300)
