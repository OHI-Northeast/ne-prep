...
Calculate score for havingStock Assessment Score
```{r}
...
location of stocks that don't have a location
...
enforcement_compliance_scores <- ole %>% 
  ...
  rowwise() %>% 
  mutate(enforcement_score= mean(c(enforcement_score_OLE, enforcement_score_obser), na.rm=F))
