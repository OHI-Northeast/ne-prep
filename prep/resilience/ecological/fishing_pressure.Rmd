...
write.csv(percent_assessed_by_region, file = "data/percent_assessed_by_region")
```
...
write.csv(fish_ob_score, file = "data/fish_ob_score")
```
...
write.csv(enforcement_compliance_scores, file = "data/enforcement_compliance_scores")
```
