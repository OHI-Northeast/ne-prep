...
lots of data tiddying/wrangling here for location of species that don't have a region associtated with them
```{r}
...
%>% 
  mutate(rgn_name = case_when(stock_long == "skipjack tuna-Western Atlantic" ~ rep(11)))
