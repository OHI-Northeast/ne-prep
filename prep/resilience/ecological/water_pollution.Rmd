...
#percentage reports submitted in maine 2009
53585/85510 #62.67%

## New Hampshire
new_hampshire_2009 <- ME_FY2009_NPDES_DMRS

new_hampshire_2009$DAYS_LATE[is.na(new_hampshire_2009$DAYS_LATE)] <- 0

new_hampshire_2009 <- new_hampshire_2009 %>% 
  select(EXTERNAL_PERMIT_NMBR, DAYS_LATE) %>% 
  filter(DAYS_LATE == 0)

#expected ____ reports
# did not receive ___

#percentage reports submitted in new hampshire 2009
...
#write.csv(dmr_submissions, file = "dmr_submissions")
