...
**Calculating Scores**
For the water pollution resilience scores (wp_res_scores) a score of 1 is optimal

4 metrics go into the calculation:
...
ME_FY2009_NPDES_DMRS # and the rest of the report data. all 54 of them!
