...
**Description**:  Total number of jobs and wages per sector for RI, ME, MA, CT, and NH counties from 2005 to 2016. The data also include number of establishments and GDP for each sector - state - year.  
