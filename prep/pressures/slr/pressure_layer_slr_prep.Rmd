...
r_3nm_mask <- raster('~/github/ne-prep/spatial/ocean_rasters/rast_3nm_mask.tif')
    
# function that rasterizes the nc file, rotates, crops, projects and masks
    
months_coast <- function(x){
  
  m_yr <- substr(x, 108, 116) #i think it needs to be 116, double check
  ...
  writeRaster(r, filename=paste0(dir_anx,'/prep/pressures/slr/v2016/out/msla_monthly_coast/msla_monthly_coast_',m_yr,'.tif'), overwrite=T)
}

'/prs_slr/output/msla_monthly_coast/msla_monthly_coast_'
