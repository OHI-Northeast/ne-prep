...
# Reference Point
The reference point is the 99.99th quantile of the entire data distribution from 1993 - 2018 for the entire Northeast region.
...
JULIETTE: add a chunk that is a simple line chart of region pressure scores over time.
