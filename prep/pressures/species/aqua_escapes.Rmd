...
## Graph
```{r graph}
escape_pro_graph <-ggplot(escape_pro)+
...
ggsave(file.path(dir_git, "prep/pressures/aquaculture/figs/escape_goal_meth_graph.png"), width=7, height=5, dpi=300)
```
