...
```{r calculate_score}
habitat_pro <- left_join(production, sf_watch, by = ("Species")) %>% 
  mutate(prs = (AqCriteria3/10),
...
Graph
```{r graph}
habitat_pro_graph <-ggplot(habitat_pro)+
...
ggsave(file.path(dir_git, "prep/pressures/aquaculture/figs/habitat_pro_graph.png"), width=7, height=5, dpi=300)
```
