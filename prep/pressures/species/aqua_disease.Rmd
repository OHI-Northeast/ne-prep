...
disease_prs_int <- left_join(production_subrgns, sf_watch, by = ("Species")) %>% 
...
## we calculated the reference point in 2019 as 2*max(disease_prs_rgn12$scaled_area_prod) = 5305 to give the pressure some room to grow. We will manually input it here instead of recalcualting each year, resulting in a moving reference point where the highest production year will likely be the most recent
```
