...
```{r visualize}  
aqu_dis_graph <-ggplot(aqu_disease_prs)+
...
ggsave(file.path(dir_git, "prep/pressures/aquaculture/aqu_dis_graph.png"), width=7, height=5, dpi=300)
```
