...
Since we do not have historic data, we used a base of 1.5 taken from Ries et. al 2009. At this saturation level, some of our fished species begin exhibiting decalcification.
...
map_scores(last_year, score_var = last_year$pressure_score, scale_label = "Pressure Score", map_title = "Ocean Acidification")
```
