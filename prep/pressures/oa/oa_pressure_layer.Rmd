...
names(nc$var) # names for lat/long are different, so double check
...
# might want to go in and change these files. not quite sure what the equivilant os 2017 is, different folder structure and it has more file years 
...
r_2015 <- raster(file.path(dir_M,'git-annex/globalprep/prs_oa/v2017/int/global_arag_avg_moll_2016.tif'))
