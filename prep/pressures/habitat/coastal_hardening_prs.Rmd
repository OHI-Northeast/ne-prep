...
however we redid the analysis because of new new avaliability and different regions of interest.
...
This buffer is not perfect. There is some overlap along rivers state lines. Howvever, this buffer does capture the majority of the coastline now.
```{r state_water_shape}
...
coast_arm <-  read_sf(file.path(dir_anx, "prs_hab/coastal_hardening/shapefiles/erma.shp")) %>% 
