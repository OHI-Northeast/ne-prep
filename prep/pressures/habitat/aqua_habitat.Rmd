...
aq_hab_prs_int <- left_join(production, sf_watch, by = ("Species")) %>% 
...
## we calculated the reference point in 2019 as 2*max(aq_hab_prs_rgn12$scaled_area_prod, na.rm = TRUE) = 7093 to give the pressure some room to grow. We will manually input it here instead of recalcualting each year, resulting in a moving reference point where the highest production year will likely be the most recent
```
