...
lsp_data_info <- data.frame(
  ...
  Target = c("10% of coastal waters protected (Aichi target)", 
             "17% of coastal land (1km from coast) protected (Aichi target)"),
  Source = c('<a href="https://maps.usgs.gov/padus/">USGS Protected Areas Database v2.0</a>',
             '<a href="https://maps.usgs.gov/padus/">USGS Protected Areas Database v2.0</a>'))
