...
Get a sense of the data. It looks like there are `r length(unique(assessment_data$Stock))` stocks.
...
###NEED TO THINK ABOUT WHETHER THIS IS THE RIGHT PLACE TO GAPFILL. Also we should remove species with limited time series (e.g. Atlantic Mackerel has just 2005 B/Bmsy and 2018 F/fmsy). Gapfilling these causes a lot of weirdness.
