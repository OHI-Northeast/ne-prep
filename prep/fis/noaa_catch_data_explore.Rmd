...
sp <- c("CLAM, SURF", "CRAB, RED", "MARLIN, WHITE", "MONK HEADS", "OCEAN QUAHOG", "TUNA, SKIPJACK", "TUNA, BIG EYE", "TILEFISH", "SKATE, THORNY", "SKATE, WINTER (BIG)", "SKATE, SMOOTH", "SKATE, LITTLE (SUMMER)", "SKATE, CLEARNOSE", "SKATE, BARNDOOR", "SKATE WINGS, WINTER (BIG)", "SKATE WINGS, LITTLE (SUMMER)", "TILEFISH, GOLDEN", "TILEFISH, BLUELINE")
